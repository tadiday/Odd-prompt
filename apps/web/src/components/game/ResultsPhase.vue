...
.next-round-action button:hover {
...
.summary-grid article.odd {
  border-color: var(--red);
  background: #fff7f7;
}

.summary-grid small, .winner-card small {
  font-size: 0.75rem;
  font-weight: 900;
}
...
.table-head, .table-wrap article {
  display: grid;
  grid-template-columns: 1.25fr 0.9fr 1.5fr 0.65fr;
  align-items: center;
}
...
.table-wrap article > b {
  color: #1ca54c;
  font-size: 0.75rem;
}

.table-wrap article.imposter > b {
  color: var(--red);
}

.table-wrap article p {
  margin: 0;
}
...
.winner-card.imposter-win {
  border-color: var(--red);
  background: #fff7f7;
}

.winner-card.imposter-win strong {
  color: var(--red) !important;
}
...
@media (max-width: 760px) {
  ...
  .table-wrap article {
    grid-template-columns: 1.2fr 1fr 0.8fr 0.3fr;
  }
  .summary-grid {
    grid-template-columns: 1fr;
  }
